...
export const ZONES: ZoneConfig[] = [
  {
    ...
    interactables: ['sign_library', 'sign_cafe', 'sign_park', 'sign_arcade', 'sign_welcome', 'npc_wanderer'],
  ...
  },
  {
    ...
    interactables: ['focus_pod_1', 'focus_pod_2', 'focus_pod_3', 'focus_pod_4', 'reading_nook', 'npc_librarian', 'door_town_square'],
  ...
  },
  {
    ...
    interactables: ['jukebox', 'counter_barista', 'booth_1', 'booth_2', 'table_1', 'table_2', 'door_town_square'],
    voiceChatDefault: 'unmuted',
    bgColorToken: 'cafeBg',
  },
  {
  ...
  },
  {
    ...
    ambientSound: 'ambient_outdoor',
    interactables: ['bandstand', 'bench_1', 'bench_2', 'bench_3', 'door_town_square'],
    voiceChatDefault: 'unmuted',
    bgColorToken: 'parkBg',
  },
  {
